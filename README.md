...
You can change the difficulty of the AI by pressing the *Change AI* button. The AI has a difficulty between 1 and 9. The AI can be beaten on different AI's as of now. There are different winning plays for different levels. 
